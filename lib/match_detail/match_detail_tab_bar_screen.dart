            ...
            SpeedDialChild(
              ...
              onTap: () {
                Navigator.of(context)
                    .pushNamed(AddEditOpponentInfoScreen.routeName);
              },
            ),
            SpeedDialChild(
              child: Icon(
              ...
              onTap: () {
                Navigator.of(context)
                    .pushNamed(AddEditTacticalGoalsScreen.routeName);
              },
            ),
            SpeedDialChild(
              child: Icon(
              ...
              onTap: () {
                Navigator.of(context)
                    .pushNamed(AddEditMentalGoalsScreen.routeName);
              },
            ),
            SpeedDialChild(
              child: Icon(
              ...
              onTap: () {
                Navigator.of(context)
                    .pushNamed(AddEditOtherGoalsScreen.routeName);
              },
            ),
          ],
        ),
